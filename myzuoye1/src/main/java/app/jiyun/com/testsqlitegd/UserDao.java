...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Conner = new Property(2, String.class, "conner", false, "CONNER");
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        String conner = entity.getConner();
        if (conner != null) {
            stmt.bindString(3, conner);
        }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // conner
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setConner(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
